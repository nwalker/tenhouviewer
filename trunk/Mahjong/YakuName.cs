    ...
    static class YakuName
    {
       // static string[] YakuList = new string[55];
        ...
        static string[] YakuListEn = {"Menzen Tsumo", "Riichi", "Ippatsu", "Chankan", "Rinshan Kaihou", "Haitei Raoyue", "Houtei Raoyui",
                                      "Pinfu", "Tanyao", "Ippeiko", "Fanpai 東 (seat)", "Fanpai 南 (seat)", "Fanpai 西 (seat)",
                                      "Fanpai 北 (seat)", "Fanpai 東 (round)", "Fanpai 南 (round)", "Fanpai 西 (round)",
                                      "Fanpai 北 (round)", "Yakuhai 白", "Yakuhai 發", "Yakuhai 中", "Double Riichi", "Chiitoitsu",
